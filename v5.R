...
quotes <- data.frame(
  quote = c(
    #20260201
    "人生就像騎腳踏車，要保持平衡，你就必須一直往前騎。停下來，就會摔倒。",
    "真正的成長不是變得更厲害，而是學會接受自己的不完美，並且仍然選擇繼續往前走。",
    "不要問世界需要什麼，問問自己能成為什麼；因為世界真正需要的，是那些活出自己真正模樣的人。",
    "真正的貴族不是優於他人，而是優於過去的自己。",
    "人生的最大成就，不是從不跌倒，而是每次跌倒後都能再站起來，而且站得比之前更高。",
    "人生就像騎腳踏車，要保持平衡，就必須一直往前。",
    "無論你認為自己行還是不行，你都是對的。",
    "成功不是終點，失敗不是致命：繼續前進的勇氣才最重要。",
    "行動是所有成功的基礎",
  ...
  author = c(
    #20260201
    "愛因斯坦", "布芮尼‧布朗", "霍華德‧舒曼", "海明威", "曼德拉", "愛因斯坦", "亨利福特", "邱吉爾", "畢卡索", "斷翅的鷹", "蛋殼裡的小雞", "烏鴉與水瓶", "茶農的故事", "金戒指的故事", "麻雀與雄鷹的差別", "珍珠的由來", "大黃蜂飛行的故事",
    #20260131
    "樵夫比賽的故事", "手裡水的故事", "失聰青蛙的故事", "吊橋的故事", "跳蚤的故事", "冰山的故事", "窗外的故事", "琴弦的故事",
    
    "溫斯頓‧邱吉爾", "佚名", "喬治‧蕭伯納", "史蒂夫‧賈伯斯", "佚名", "佚名", "汪國真", "佚名", "佚名", "佚名",
    "智者與河的故事", "驢子與枯井的故事", "竹子的啟示", "窮與沒錢的故事", "畫家與路人的故事", "愛迪生的燈泡", "非洲賣鞋的故事", "老鷹重生的故事", "手錶與價值的故事", "海星男孩的故事", "馬戲團大象的故事", "蝴蝶破繭的故事", "氣球老人的故事", "沒有鞋的人", "農夫的時刻表", "懸崖邊的兩棵樹", "三隻青蛙的故事"
  ),
  category = c(
    #20260201
    "行動", "成長", "內在", "成長", "重生", "耐心", "自信", "勇氣", "行動", "潛能", "磨練", "逆境", "等待", "本質", "格局", "磨練", "格局",
    #20260131
    "專注", "重量", "噪音", "勇氣", "框架", "潛力", "視角", "平衡",
